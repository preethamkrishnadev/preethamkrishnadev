...
### ROADZEN TECHNOLOGIES — Technical Team Lead  
...
### SONY PICTURES NETWORKS INDIA — Staff Software Engineer  
...
### TRELLIX (FORMERLY MCAFEE) — Software Developer  
*Bengaluru | Jul 2021 – Jun 2022*
...
### ASCENDUM SOLUTIONS (FORMERLY SOURCEBITS) — Full Stack Developer  
*Bengaluru | Nov 2019 – Jul 2021*

**Leadership Scope:** Module owner for key client features with responsibility for delivery and
UAT coordination for Sony projects.

- Delivered secure user dashboards, admin workflows, and analytics layers for high-visibility
  client platforms.
- Acted as module owner for critical features, balancing engineering timelines with client
  expectations and quality standards.
- Supported QA cycles and performance optimization efforts across multiple releases.

---

### TIME TREE TECHNOLOGY — Founder & Developer  
*Shimoga | Aug 2016 – Nov 2019*

**Leadership Scope:** Full ownership of product development, client engagement, deployment,
and post-launch support.

- Built and deployed custom ERP-style web applications for schools and small businesses.
- Managed complete product lifecycle from requirements gathering to deployment and
  maintenance.
- Delivered scalable, production-ready systems while handling client onboarding and support.
...
- **Shark Tank India Admin System:** Architected multi-phase evaluation, scoring, and legal
  compliance backend using Laravel and Vue.js.
- **KBC Play Along Platform:** Designed and implemented a highly scalable interactive gaming
  platform with leaderboard logic supporting millions of concurrent users.
